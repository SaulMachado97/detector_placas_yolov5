            ...
            if "letras" in placaDetect and "numeros" in placaDetect:
                if "texto" in placaDetect['letras'] and "texto" in placaDetect['numeros']:
                    ...
                    if class_name in ["placa"] and confidence >= confidence_threshold:
                        ...
                        img_path = save_path + "plate_" + str(licensePlateValue) + "_in.png"
                        ...
                        try:
                            time.sleep(2)
                            api_url = "https://easy-in-easy-out-app-f99f5da14d83.herokuapp.com" + "/api/services"  # Reemplaza con la URL de tu API
